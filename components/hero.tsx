  ...
  return (
    <section id="top" className="relative overflow-hidden pt-32 sm:pt-40">
      ...
      >
        ...
        <motion.div className="mt-6 flex items-center gap-2 text-sm text-white/80" variants={staggerItemVariants}>
        ...
        <motion.h1 className="mt-6 max-w-4xl text-balance font-heading text-4xl font-bold leading-[1.05] tracking-tight text-white/95 sm:text-6xl" variants={staggerItemVariants}>
        ...
        <motion.p className="mt-6 max-w-2xl text-pretty text-lg leading-relaxed text-white/85" variants={staggerItemVariants}>
        ...
        <motion.div className="mt-8 flex items-center gap-2 text-sm text-white/80" variants={staggerItemVariants}>
        ...
        <motion.dl className="mt-12 grid grid-cols-3 gap-4 border-t border-border pt-8 sm:max-w-2xl" variants={staggerContainerVariants}>
          {STATS.map((s) => (
            <motion.div key={s.label} variants={staggerItemVariants}>
              ...
              <dd className="font-heading text-3xl font-bold text-white/95 sm:text-4xl">{s.value}</dd>
        ...
        <motion.div className="mt-12" variants={staggerItemVariants}>
          <p className="font-mono text-xs font-medium uppercase tracking-[0.25em] text-white/80">
            {"// Tools I work with"}
          </p>
