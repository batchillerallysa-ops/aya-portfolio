      ...
      >
        <motion.div className="grid gap-12 lg:grid-cols-2 lg:gap-16" variants={staggerContainerVariants}>
          <motion.div variants={staggerContainerVariants}>
            ...
            <motion.p className="mt-4 max-w-md text-pretty leading-relaxed text-white/80" variants={staggerItemVariants}>
              ...
              >
                ...
                <div className="mt-4 flex items-start justify-between gap-2">
                  <div className="min-w-0">
                    <p className="text-xs uppercase tracking-wide text-white/70">{c.label}</p>
                    <p className="mt-1 truncate text-sm font-medium text-white/95">{c.value}</p>
                  </div>
                  <ArrowUpRight className="h-4 w-4 flex-none text-white/70 transition-colors group-hover:text-primary" />
                </div>
              </motion.a>
            ))}
          </motion.div>
