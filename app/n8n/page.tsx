...
export const metadata: Metadata = {
  title: "n8n Automation Projects — Allysa Marie",
  description: "Explore n8n workflow automation projects including AI agents, web scraping, content generation, and social media integration.",
}

const n8nProjects = projects.filter((p) => p.tool === "n8n")
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <header className="border-b border-border sticky top-0 z-40 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
        <div className="container mx-auto flex items-center justify-between px-4 py-4 sm:px-6">
          ...
          <h1 className="text-lg font-semibold">n8n Projects</h1>
          <div className="w-16" />
        </div>
      </header>
      ...
      <main className="container mx-auto px-4 py-12 sm:px-6">
        ...
        <div className="mb-12">
          ...
          <p className="text-pretty text-lg text-muted-foreground">
            Discover how I&apos;ve used n8n to build AI agents, scrape data, generate content, and create sophisticated automation workflows.
            Each project showcases advanced workflow design with AI integration and complex logic.
          </p>
        </div>
        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
          {n8nProjects.map((project) => {
            ...
            return (
              <Link
                key={project.slug}
                href={`/projects/n8n/${project.slug}`}
        ...
        <div className="mt-16 rounded-2xl border border-border bg-card p-8">
          <h3 className="text-lg font-semibold mb-6">n8n Expertise</h3>
          <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
            <div>
              <p className="text-3xl font-bold text-primary">{n8nProjects.length}</p>
